...
import { initials, avatarTint } from "@/lib/ui";
    ...
    <div className="flex min-h-screen">
      <aside className="hidden w-60 shrink-0 flex-col border-r border-slate-200 bg-white lg:flex">
        <div className="flex items-center gap-2.5 px-5 py-5">
          <div className="grid h-8 w-8 place-items-center rounded-lg bg-indigo-600 text-sm font-semibold text-white">
            N
          </div>
          <div className="min-w-0">
            ...
            <div className="text-xs text-slate-500">Recruitment</div>
          </div>
        </div>
